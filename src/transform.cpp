...
void Transform::transform(double in[3]) {
    double rotateZ[3][3] = {{cos(45.0 * PI/180.0), -sin(45.0 * PI/180.0), 0.0},
							{sin(45.0 * PI/180.0), cos(45.0 * PI/180.0), 0.0},
							{0.0, 0.0, 1.0}};
	...
	//^^Rotates 3D points (90.0 - 30.00) degrees around the X-axis.
